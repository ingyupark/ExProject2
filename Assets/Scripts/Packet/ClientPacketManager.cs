...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SSlotCount, MakePacket<S_Slot_Count>);
        _handler.Add((ushort)MsgId.SSlotCount, PacketHandler.S_SlotCountHandler);

		_onRecv.Add((ushort)MsgId.SChangeIcount, MakePacket<S_Change_Icount>);
		_handler.Add((ushort)MsgId.SChangeIcount, PacketHandler.S_Change_IcountHandler);
		_onRecv.Add((ushort)MsgId.SDrunkItem, MakePacket<S_Drunk_Item>);
		_handler.Add((ushort)MsgId.SDrunkItem, PacketHandler.S_Drunk_ItemHandler);
		_onRecv.Add((ushort)MsgId.SChangeSp, MakePacket<S_ChangeSp>);
		_handler.Add((ushort)MsgId.SChangeSp, PacketHandler.S_ChangeSpHandler);
		_onRecv.Add((ushort)MsgId.SChat, MakePacket<S_Chat>);
		_handler.Add((ushort)MsgId.SChat, PacketHandler.S_ChatHandler);
		_onRecv.Add((ushort)MsgId.SAddgold, MakePacket<S_AddGold>);
		_handler.Add((ushort)MsgId.SAddgold, PacketHandler.S_AddGoldHandler);
		_onRecv.Add((ushort)MsgId.SGoldlist, MakePacket<S_GoldList>);
		_handler.Add((ushort)MsgId.SGoldlist, PacketHandler.S_GoldListHandler);
		_onRecv.Add((ushort)MsgId.SBuynpc, MakePacket<S_Buynpc>);
		_handler.Add((ushort)MsgId.SBuynpc, PacketHandler.S_BuyNpcHandler);
		_onRecv.Add((ushort)MsgId.SAlarm, MakePacket<S_Alarm>);
		_handler.Add((ushort)MsgId.SAlarm, PacketHandler.S_S_AlarmHandler);
